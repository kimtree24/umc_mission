...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -886674859L;
    ...
    public final umm.spring.study.domain.QMember member;

    public final umm.spring.study.domain.QMission mission;

    public final EnumPath<umm.spring.study.domain.enums.MissionStatus> status = createEnum("status", umm.spring.study.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umm.spring.study.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umm.spring.study.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
